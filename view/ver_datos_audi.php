...
$sql_archivos = "SELECT * FROM archivos_auditoria WHERE id_pqr = '$id' ORDER BY id DESC";
$result_archivos = $conn->query($sql_archivos);

$sql_datos = "SELECT * FROM auditoria WHERE id = '$id'";
$result_datos = $conn->query($sql_datos);

$sql_datos2 = "SELECT * FROM auditoria WHERE id = '$id'";
$result_datos2 = $conn->query($sql_datos2);

$sql_datos3 = "SELECT * FROM auditoria WHERE id = '$id'";
$result_datos3 = $conn->query($sql_datos3);

$sql_datos4 = "SELECT * FROM auditoria WHERE id = '$id'";
$result_datos4 = $conn->query($sql_datos4);

$sql_historial = "SELECT * FROM historial_auditoria WHERE id_original = '$id' ORDER BY id DESC";
$result_historial = $conn->query($sql_historial);

$sql_legal = "SELECT * FROM legal_auditoria WHERE id_pqr = '$id' ORDER BY id DESC";
...
<div>
    ...
    <button class="Btn_volver">
        ...
        <a href="#" style="color: white; text-decoration: none;" data-form="visualizar_audi" class="link-dark rounded">
    ...
    <div style="border: 1px solid #000; padding: 10px; border-radius: 20px;">
        <?php if (isset($result_datos) && $result_datos->num_rows > 0) : ?>
            <h2 style="text-align: center;"> Informacion Auditoria</h2>
    ...
    <!-- check list -->
    <?php if ($cargo === 'admin' || $cargo === 'analista_pf') : ?>
        <form class="modificar" id="checks">
            <div class="checkbox-wrapper-65">
                <label for="cbk1-61">
                    <input id="cbk1-61" name="habeas_data" type="checkbox">
                    <span class="cbx">
            ...
            <div class="checkbox-wrapper-65">
                <label for="cbk1-62">
                    <input id="cbk1-62" name="ley_2300" type="checkbox">
                    <span class="cbx">
                        <svg viewBox="0 0 12 11" height="11px" width="12px">
                            <polyline points="1 6.29411765 4.5 10 11 1"></polyline>
                        </svg>
            ...
            <div class="checkbox-wrapper-65">
                <label for="cbk1-63">
                    <input id="cbk1-63" name="mala_gestion" type="checkbox">
                    <span class="cbx">
                        <svg viewBox="0 0 12 11" height="11px" width="12px">
                            <polyline points="1 6.29411765 4.5 10 11 1"></polyline>
                        </svg>
                    </span>
                    <span>Mala Practica Gestion Comercial</span>
                </label>
            </div>
            <div class="checkbox-wrapper-65">
                <label for="cbk1-64">
                    <input id="cbk1-64" name="suplantacion" type="checkbox">
                    <span class="cbx">
                        <svg viewBox="0 0 12 11" height="11px" width="12px">
                            <polyline points="1 6.29411765 4.5 10 11 1"></polyline>
                        </svg>
                    </span>
                    <span>Suplantacion De Identidad</span>
                </label>
            </div>
            <div class="checkbox-wrapper-65">
                <label for="cbk1-65">
                    <input id="cbk1-65" name="lectura_contrato" type="checkbox">
                    <span class="cbx">
                        <svg viewBox="0 0 12 11" height="11px" width="12px">
                            <polyline points="1 6.29411765 4.5 10 11 1"></polyline>
                        </svg>
                    </span>
                    <span>Lectura De Contrato</span>
                </label>
            </div>
            <button type="submit" class="btn_modificar" id="check_list">Guardar</button>
        </form>
    <?php else : ?>
    <?php endif; ?>
    <br><br><br>
...
<script>
    ...
    function actualizarTabla() {
        ...
        var url = "../php/refresh_img_audi.php?id=" + encodeURIComponent(id) + "&documento=" + encodeURIComponent(documento) + "&telefono=" + encodeURIComponent(telefono);
    ...
    function actualizarTabla2() {
        ...
        // Construir la URL con los parámetros
        var url = "../php/refresh_retroalimentacion_audi.php?id=" + encodeURIComponent(id) + "&documento=" + encodeURIComponent(documento) + "&telefono=" + encodeURIComponent(telefono);
    ...
    function actualizarTabla3() {
        ...
        // Construir la URL con los parámetros
        var url = "../php/refresh_historial_audi.php?cun=" + encodeURIComponent(cun) + "&documento=" + encodeURIComponent(documento) + "&telefono=" + encodeURIComponent(telefono) + "&id=" + encodeURIComponent(id);
    ...
    function actualizarTabla4() {
        ...
        // Construir la URL con los parámetros
        var url = "../php/refresh_datosA.php?cun=" + encodeURIComponent(cun) + "&documento=" + encodeURIComponent(documento) + "&telefono=" + encodeURIComponent(telefono) + "&id=" + encodeURIComponent(id);
    ...
    function actualizarTabla5() {
        ...
        // Construir la URL con los parámetros
        var url = "../php/refresh_textarea_audi.php?cun=" + encodeURIComponent(cun) + "&documento=" + encodeURIComponent(documento) + "&telefono=" + encodeURIComponent(telefono) + "&id=" + encodeURIComponent(id);
    ...
    function actualizarTabla6() {
        ...
        // Construir la URL con los parámetros
        var url = "../php/refresh_legal_audi.php?cun=" + encodeURIComponent(cun) + "&documento=" + encodeURIComponent(documento) + "&telefono=" + encodeURIComponent(telefono) + "&id=" + encodeURIComponent(id);
    ...
    function actualizarTabla7() {
        ...
        // Construir la URL con los parámetros
        var url = "../php/refresh_datos2A.php?cun=" + encodeURIComponent(cun) + "&documento=" + encodeURIComponent(documento) + "&telefono=" + encodeURIComponent(telefono) + "&id=" + encodeURIComponent(id);
    ...
    //actualizar tabla datos4
    function actualizarTabla8() {
        // Obtener los valores de los parámetros
        var cun = '<?php echo $cun; ?>';
        var documento = '<?php echo $documento; ?>';
        var telefono = '<?php echo $telefono; ?>';
        ...
        xmlhttp.onreadystatechange = function() {
            if (this.readyState == 4 && this.status == 200) {
                document.querySelector('.container_datos4').innerHTML = this.responseText;
            }
        };

        // Construir la URL con los parámetros
        var url = "../php/refresh_check.php?cun=" + encodeURIComponent(cun) + "&documento=" + encodeURIComponent(documento) + "&telefono=" + encodeURIComponent(telefono) + "&id=" + encodeURIComponent(id);
    ...
    $(document).ready(function() {
        ...
        $('#modificar').submit(function(e) {
            ...
            $.ajax({
                url: '../php/modificar_auditoria.php',
                type: 'POST',
                data: formData,
                contentType: false,
                processData: false,
        ...
        $('#form_retroalimentacion').submit(function(e) {
            ...
            // Realizar una petición AJAX para insertar el cliente en la base de datos
            $.ajax({
                url: '../php/retroalimentacion_audi.php',
                type: 'POST',
                data: formData,
                contentType: false,
                processData: false,
