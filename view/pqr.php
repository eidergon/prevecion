...
<div class="body">
    <div class="container">
        <div class="heading">Crear PQR</div>
        <form class="form" id="crear">
            ...
            <input required class="input" name="cun" id="cun" placeholder="CUN" pattern="[0-9]+" title="Ingrese solo números">
            <input required class="input" name="id_venta" id="id_venta" placeholder="ID Venta" pattern="[0-9]+" title="Ingrese solo números">
